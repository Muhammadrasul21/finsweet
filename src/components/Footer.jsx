    ...
    <div className='footer bg-black text-white'>
      <div className='container'>
         ...
         <div className='flex flex-col gap-2'>
          <p className='font-bold text-[40px] w-[440px]'>Subscribe to get latest updates</p>
          <div className='footerBtn border w-[544px] flex justify-between rounded-[4px]'>
            <input type="text" className='text-white ' placeholder='Your email' />
            <button className='bg-white text-black w-[136px] h-16 rounded-[4px]'>Subscribe</button>
          </div>
         </div>
         </div>
      </div>
